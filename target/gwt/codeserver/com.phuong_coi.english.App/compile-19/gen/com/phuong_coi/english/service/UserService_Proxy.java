...
public class UserService_Proxy extends RemoteServiceProxy implements com.phuong_coi.english.service.UserServiceAsync {
  ...
  private static final String SERIALIZATION_POLICY ="5044EA8C6942D9D6D537C86D4F888797";
  ...
  public void updateUser(com.phuong_coi.english.model.User user, java.lang.String phoneNumber, com.google.gwt.user.client.rpc.AsyncCallback callback) {
    com.google.gwt.user.client.rpc.impl.RemoteServiceProxy.ServiceHelper helper = new com.google.gwt.user.client.rpc.impl.RemoteServiceProxy.ServiceHelper("UserService_Proxy", "updateUser");
    try {
      SerializationStreamWriter streamWriter = helper.start(REMOTE_SERVICE_INTERFACE_NAME, 2);
      streamWriter.writeString("com.phuong_coi.english.model.User/423129655");
      streamWriter.writeString("java.lang.String/2004016611");
      streamWriter.writeObject(user);
      streamWriter.writeString(phoneNumber);
      helper.finish(callback, ResponseReader.OBJECT);
    } catch (SerializationException ex) {
      callback.onFailure(ex);
    }
